...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w", 
    	function () 
		awful.util.spawn("bash /home/tejasm/.config/rofi/rofi-wifi-menu.sh") end,
		{description = "show wifi menu", group = "custom"}),
...
--Custom keys
    ...
    awful.key({ modkey }, "f", 
		...
		{description = "File Browser", group = "custom"}),

    awful.key({ modkey }, "t", 
    	function () 
		awful.util.spawn("telegram-desktop") end,
		{description = "Telegram", group = "custom"}), 

    awful.key({ modkey }, "g", 
    	function () 
		awful.util.spawn{"gedit"} end,
		{description = "Notepad", group = "custom"}), 

    awful.key({ modkey }, "d", 
    	function () 
		awful.util.spawn{"discord"} end,
		{description = "Discord", group = "custom"}),

    awful.key({ modkey }, "Print", 
    	function () 
		awful.util.spawn("xfce4-screenshooter -s ~/Pictures") end,
		{description = "Screenshot", group = "custom"}),

    awful.key({ modkey }, "XF86MonBrightnessUp", 
    	function () 
		awful.util.spawn("brightnessctl set +10") end,
		{description = "Brightness Increase", group = "custom"}),

    awful.key({ modkey }, "XF86MonBrightnessDown", 
    	function () 
		awful.util.spawn("brightnessctl set 10-") end,
		{description = "Brightness Decrease", group = "custom"}),

    awful.key({ modkey }, "XF86AudioRaiseVolume", 
    	function () 
		awful.util.spawn("pactl set-sink-volume 0 +10%") end,
		{description = "Increse Volume", group = "custom"}),

    awful.key({ modkey }, "XF86AudioLowerVolume", 
    	function () 
		awful.util.spawn("pactl set-sink-volume 0 -10%") end,
		{description = "Decrese Volume", group = "custom"}),
    ...
    awful.key({ modkey }, "p", 
    	function() 
		awful.util.spawn("bash /home/tejasm/.config/rofi/powermenu.sh") end,
		{description = "show the powermenu", group = "custom"})
)
